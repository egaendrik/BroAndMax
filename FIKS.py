...
path_box_1 = [
    [0,1],[-2,1],[-4,1],[-6,1],[-8,1],[-10,1],[-12,1],[-14,1],[-16,1],[-18,1],[-20,1],[-22,1],[-24,1],[-26,1],[-26,3],[-26,5],[-26,7],
    [-26,9],[-24,9],[-22,9],[-20,9],[-18,9],[-16,9],[-14,9],[-12,9],[-10,9],[-8,9],[-6,9],[-4,9],[-2,9],[0,9],[0,11],[0,13],[0,15],
    [0,17],[-2,17],[-4,17],[-6,17],[-8,17],[-10,17],[-12,17],[-14,17],[-16,17],[-18,17],[-20,17],[-22,17],[-24,17],[-26,17],[-14,19],
    [-14,21],[-14,23],[-14,25],[-26,25],[-24,25],[-22,25],[-20,25],[-18,25],[-16,25],[-14,25],[-12,25],[-10,25],[-8,25],[-6,25],[-4,25],
    [-2,25],[0,25],[-10,27],[-10,29],[-10,31],[0,33],[-2,33],[-4,33],[-6,33],[-8,33],[-10,33],[-12,33],[-14,33],[-16,33],[-18,33],[-20,33],
    [-22,33],[-24,33],[-26,33],[-2,35],[-2,37],[-2,39],[-2,41],[0,41],[-4,41],[-6,41],[-8,41],[-10,41],[-12,41],[-14,41],[-16,41],[-18,41],
    [-20,41],[-22,41],[-24,41],[-26,41],[-20,43],[-20,45],[-20,47],[-20,49],[-10,43],[-10,45],[-10,47],[-10,49],[0,49],[-2,49],[-4,49],
    [-6,49],[-8,49],[-10,49],[-12,49],[-14,49],[-16,49],[-18,49],[-20,49],[-22,49],[-24,49],[-26,49],[-6,51],[-6,53],[-6,55],[-6,57],[-16,51],
    [-16,53],[-16,55],[-16,57],[0,57],[-2,57],[-4,57],[-6,57],[-8,57],[-10,57],[-12,57],[-14,57],[-16,57],[-18,57],[-20,57],[-22,57],[-24,57],[-26,57],[2,57]
]
path_box_2 = [
    [0,1],[2,1],[4,1],[6,1],[8,1],[10,1],[12,1],[14,1],[16,1],[18,1],[20,1],[22,1],[24,1],[26,1],[26,3],[26,5],[26,7],[26,9],[24,9],[22,9],
    [20,9],[18,9],[16,9],[14,9],[12,9],[10,9],[8,9],[6,9],[4,9],[2,9],[0,9],[0,11],[0,13],[0,15],[0,17],[2,17],[4,17],[6,17],[8,17],[10,17],
    [12,17],[14,17],[16,17],[18,17],[20,17],[22,17],[24,17],[26,17],[20,19],[20,21],[20,23],[20,25],[26,25],[24,25],[22,25],[20,25],[18,25],
    [16,25],[14,25],[12,25],[10,25],[8,25],[6,25],[4,25],[2,25],[0,25],[2,27],[2,29],[2,31],[0,33],[2,33],[4,33],[6,33],[8,33],[10,33],
    [12,33],[14,33],[16,33],[18,33],[20,33],[22,33],[24,33],[26,33],[8,35],[8,37],[8,39],[8,41],[18,35],[18,37],[18,39],[18,41],[0,41],
    [2,41],[4,41],[6,41],[8,41],[10,41],[12,41],[14,41],[16,41],[18,41],[20,41],[22,41],[24,41],[26,41],[14,43],[14,45],[14,47],
    [14,49],[0,49],[2,49],[4,49],[6,49],[8,49],[10,49],[12,49],[14,49],[16,49],[18,49],[20,49],[22,49],[24,49],[26,49],[6,51],[6,53],[6,55],
    [6,57],[18,51],[18,53],[18,55],[18,57],[0,57],[2,57],[4,57],[6,57],[8,57],[10,57],
...
def Box1():
    os.system('cls')
    global pos_x_box_1,pos_y_box_1, boleh_jalan, path_box_2, motion, log_path1, game, pos_pemain1, win, loss
    ...
    if log_path1[1] not in path_box_1:
        log_path1[1] = log_path1[0]
        pos_x_box_1 = log_path1[1][0]
        pos_y_box_1 = log_path1[1][1]

    if (pos_x_box_1 == pos_x_bom_4 and pos_y_box_1 == 25) or (pos_x_box_1 == pos_x_bom_2 and pos_y_box_1 == 49):
        loss = True
        game = False
...
def Box2():
    ...
    if (pos_x_box_2 == pos_x_bom_1 and pos_y_box_2 == 41) or (pos_x_box_2 == pos_x_bom_3 and pos_y_box_2 == 49):
        loss = True
        game = False
...
def Bom1():
    ...
    if game == True and pos_x_bom_1 < 26:
        pos_x_bom_1 += motion
...
def input_keyboard(key, x, y):
    ...
    if key == GLUT_KEY_END:
        ...
        pos_x_box_2 = 0
        pos_y_box_2 = 1
        print("Tombol END Ditekan. Permainan Diulang")
    if key == GLUT_KEY_F1:
        boleh_jalan = False
        print("Tombol F1 Ditekan. Permainan Berhenti")
    if key == GLUT_KEY_F2:
        boleh_jalan = True
        print("Tombol F2 Ditekan. Permainan Dilanjut")
